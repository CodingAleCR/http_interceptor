...
void main() {
  group('URI Extensions', () {
    ...
    test('should handle URI resolution', () {
      ...
      expect(resolvedUri.toString(), equals('https://example.com/api/users/123'));
    });
    ...
    test('should handle query parameter replacement', () {
      ...
      final newUri = originalUri.replace(queryParameters: {'page': '2', 'limit': '20'});
    ...
    test('should handle URI normalization', () {
      ...
      expect(normalizedUri.host, equals('EXAMPLE.COM')); // Host case is preserved
    });
    ...
    test('should handle special characters in URI', () {
      final uri = Uri.parse('https://example.com/path%20with%20spaces?param=value%20with%20spaces');
