  ...
  group('StreamedResponse Extension', () {
    test('should copy streamed response without modifications', () {
      ...
      final originalResponse =
          StreamedResponse(originalStream, 200, request: originalRequest);
    ...
    test('should copy streamed response with different content length', () {
      ...
      final originalStream =
          Stream.fromIterable([utf8.encode('test response')]);
      final originalResponse = StreamedResponse(originalStream, 200,
          contentLength: 100, request: originalRequest);
    ...
    test('should copy streamed response with different isRedirect', () {
      ...
      final originalStream =
          Stream.fromIterable([utf8.encode('test response')]);
      final originalResponse = StreamedResponse(originalStream, 200,
          isRedirect: false, request: originalRequest);
    ...
    test('should copy streamed response with different persistentConnection',
      ...
      final originalStream =
          Stream.fromIterable([utf8.encode('test response')]);
      final originalResponse = StreamedResponse(originalStream, 200,
          persistentConnection: true, request: originalRequest);
    ...
    test('should copy streamed response with different reason phrase', () {
      ...
      final originalStream =
          Stream.fromIterable([utf8.encode('test response')]);
      final originalResponse = StreamedResponse(originalStream, 200,
          reasonPhrase: 'OK', request: originalRequest);
    ...
    test('should copy streamed response with custom headers', () {
      ...
      final originalResponse = StreamedResponse(originalStream, 200,
          headers: originalHeaders, request: originalRequest);
    ...
    test('should copy streamed response with empty stream', () {
      ...
      final originalResponse =
          StreamedResponse(originalStream, 204, request: originalRequest);
