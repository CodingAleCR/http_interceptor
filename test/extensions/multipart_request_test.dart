...
void main() {
  group('MultipartRequest Extension', () {
    test('should copy multipart request without modifications', () {
      final originalRequest = MultipartRequest('POST', Uri.parse('https://example.com/upload'));
    ...
    test('should copy multipart request with different fields', () {
      ...
      final newFields = {'new_field': 'new_value', 'another_field': 'another_value'};
    ...
    test('should copy multipart request with different HTTP methods', () {
      ...
      for (final method in methods) {
        final originalRequest = MultipartRequest(method.asString, Uri.parse('https://example.com/upload'));
        originalRequest.fields['field1'] = 'value1';
    ...
    test('should copy multipart request with custom headers', () {
      final originalRequest = MultipartRequest('POST', Uri.parse('https://example.com/upload'));
      originalRequest.headers['Content-Type'] = 'multipart/form-data; boundary=----WebKitFormBoundary';
