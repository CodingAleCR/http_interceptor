...
void main() {
  group('Query Parameters Tests', () {
    ...
    test('should preserve URI components', () {
      final uri = Uri.parse('https://user:pass@example.com:8080/path?existing=value#fragment');
    ...
    test('should handle complex parameter values', () {
      ...
      expect(result.queryParameters['with spaces'], equals('value with spaces'));
      expect(result.queryParameters['with&symbols'], equals('value&with=symbols'));
      expect(result.queryParameters['with+plus'], equals('value+with+plus'));
      expect(result.queryParameters['with%20encoding'], equals('value with encoding'));
    });
    ...
    test('should handle map parameters', () {
      ...
      expect(result.queryParameters['map'], equals('{key1: value1, key2: value2}'));
      expect(result.queryParameters['nested'], equals('{level1: {level2: value}}'));
    });
    ...
    test('should handle parameters that override existing query parameters', () {
      ...
      expect(result.queryParameters['existing'], equals('new')); // Should override
